    ...
    <div suppressHydrationWarning className="min-h-screen bg-[#09090b] text-white font-sans overflow-x-hidden selection:bg-[#0EB4A6] selection:text-white">
      ...
      <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0 opacity-20">
          ...
          {/* using one of the existing images for background */}
            ...
            {colleges.map((college) => (
              ...
              >
                ...
                <div className="p-5 flex-1 flex flex-col">
                  ...
                  <button className="w-full py-2.5 rounded-xl border border-white/10 text-sm font-medium hover:bg-white/10 transition-colors flex justify-center items-center gap-2">
                    View Details
                  </button>
                </div>
              </motion.div>
              ...
              <div className="space-y-8 mb-10">
                <div className="flex gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#0EB4A6]/10 flex items-center justify-center border border-[#0EB4A6]/20">
                    <UserCheck className="w-6 h-6 text-[#0EB4A6]" />
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2">Self Discovery</h4>
                    <p className="text-white/60 text-sm">Understand your strengths, weaknesses, and true passions through our robust assessments.</p>
                  </div>
                </div>
                
                <div className="flex gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#0EB4A6]/10 flex items-center justify-center border border-[#0EB4A6]/20">
                    <ClipboardList className="w-6 h-6 text-[#0EB4A6]" />
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2">Expert Testing</h4>
                    <p className="text-white/60 text-sm">Take our carefully crafted psychometric tests to pinpoint the best career options for you.</p>
                  </div>
                </div>
                
                <div className="flex gap-5">
                  <div className="flex-shrink-0 w-12 h-12 rounded-full bg-[#0EB4A6]/10 flex items-center justify-center border border-[#0EB4A6]/20">
                    <MessageCircle className="w-6 h-6 text-[#0EB4A6]" />
                  </div>
                  <div>
                    <h4 className="text-xl font-semibold mb-2">Personal Counseling</h4>
                    <p className="text-white/60 text-sm">Get one-on-one guidance from expert counselors who understand the academic landscape deeply.</p>
                  </div>
                </div>
              </div>
              
              <button className="bg-[#0EB4A6] hover:bg-[#0c9c90] text-white px-8 py-4 rounded-full font-semibold transition-all shadow-[0_0_20px_rgba(14,180,166,0.3)] inline-flex items-center gap-2">
      ...
      <section className="py-20 border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 divide-y md:divide-y-0 md:divide-x divide-white/10">
            ...
            >
              <h3 className="text-5xl md:text-6xl font-bold text-[#0EB4A6] mb-3">10k+</h3>
              <p className="text-lg font-medium text-white/80">Counseling Sessions</p>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              ...
              className="flex flex-col items-center justify-center text-center pt-8 md:pt-0"
            >
              <h3 className="text-5xl md:text-6xl font-bold text-[#0EB4A6] mb-3">500+</h3>
              <p className="text-lg font-medium text-white/80">Admission Colleges</p>
            </motion.div>
            <motion.div 
              initial={{ opacity: 0, scale: 0.9 }}
              whileInView={{ opacity: 1, scale: 1 }}
              ...
              className="flex flex-col items-center justify-center text-center pt-8 md:pt-0"
            >
              <h3 className="text-5xl md:text-6xl font-bold text-[#0EB4A6] mb-3">95%</h3>
              <p className="text-lg font-medium text-white/80">Satisfaction Rate</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-32 relative overflow-hidden bg-[#09090b]">
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
          ...
          >
            <button className="w-full sm:w-auto px-10 py-4 bg-[#0EB4A6] hover:bg-[#0c9c90] text-white rounded-full font-bold transition-all shadow-[0_0_20px_rgba(14,180,166,0.3)] border border-[#0EB4A6]">
              Book Admission
            </button>
            <button className="w-full sm:w-auto px-10 py-4 bg-transparent hover:bg-white/5 text-white border border-white/20 rounded-full font-bold transition-all">
              Book Counseling
            </button>
          </motion.div>
        </div>
