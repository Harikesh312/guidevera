        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5 fade-up delay-3">
              ...
              <div className="relative flex items-center">
                ...
                <input type={showPassword ? "text" : "password"} name="password" value={formData.password}
                  ...
                  className="w-full bg-[#1A1A1D] border border-white/5 rounded-xl py-3 pl-10 pr-10 text-sm text-white placeholder:text-white/25 focus:outline-none focus:border-[#0EB4A6]/50 focus:ring-1 focus:ring-[#0EB4A6]/50 transition-all"
                  required />
          ...
          <div className="flex items-center gap-3 mb-5 fade-up delay-3">
            ...
            <span className="text-xs text-white/40 leading-relaxed">
              I agree to the{" "}
              <Link href="#" className="text-[#0EB4A6] hover:underline">Terms of Service</Link>{" "}
              and{" "}
              <Link href="#" className="text-[#0EB4A6] hover:underline">Privacy Policy</Link>
            </span>
          </div>
